...
const DeveloperConsole = () => {
    ...
    const fetchApiKeys = async () => {
        try {
            ...
            const response = await http.get('/api/developer/keys', {
                timeout: 5000
            });
    ...
    const fetchUsageStats = async () => {
        try {
            ...
            const response = await http.get(`/api/developer/usage-stats/${address}`, {
                timeout: 5000
            });
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex gap-1 overflow-x-auto">
                        {[
                            ...
                            { id: 'mcp-sdk', label: 'MCP & SDK', icon: Download },
                ...
                {/* MCP & SDK Download Tab */}
                {activeTab === 'mcp-sdk' && <McpSdkDownloadTab />}
            ...
            <div className="bg-gradient-to-br from-purple-900/40 via-gray-900 to-blue-900/40 border border-purple-500/30 rounded-2xl p-8">
                ...
                <div className="bg-purple-500/10 border border-purple-500/20 rounded-xl p-4 mt-4">
                    <div className="flex items-start gap-3">
                        <Package className="text-purple-400 mt-0.5 flex-shrink-0 w-5 h-5" />
                        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-800/60 border border-gray-700 rounded-2xl p-6 hover:border-purple-500/50 transition-all">
                    ...
                    <ul className="text-sm text-gray-400 space-y-2 mb-6">
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-green-400" /> Autenticación Web3 (Wagmi/Viem)</li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-green-400" /> API Client configurado</li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-green-400" /> Gestión de API Keys</li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-green-400" /> TypeScript / JavaScript</li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-green-400" /> Compatible Node.js & Browser</li>
                    </ul>
                ...
                <div className="bg-gray-800/60 border border-gray-700 rounded-2xl p-6 hover:border-blue-500/50 transition-all">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="p-3 bg-blue-600/20 rounded-xl">
                            <Plug className="text-blue-400 w-8 h-8" />
                        </div>
                        <div>
                    ...
                    <ul className="text-sm text-gray-400 space-y-2 mb-6">
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-400" /> 13 MCP Tools incluidos</li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-400" /> Blockchain (Gas, Swap, Blockscout)</li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-400" /> AI & Security (Auditmos, Skill Creator)</li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-400" /> IoT & Supply Chain (Kinaxis)</li>
                        <li className="flex items-center gap-2"><Check className="w-4 h-4 text-blue-400" /> Trading & Governance (Alpaca, Tally)</li>
                    </ul>
